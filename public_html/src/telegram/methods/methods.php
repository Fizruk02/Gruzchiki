...
class methods {
    ...
    public function sendChatAction($action, $chat_id){
        return $this->tgpost('sendChatAction', ['chat_id'=>$chat_id, 'action'=>$action]);
    }
    ...
    public function leaveChat($chat_id){
        return $this->tgpost('leaveChat', [ 'chat_id'=> $chat_id ]);
    }
    
    /**************************************************/
    
    public function tgpost($mtd, $par){
        $res=curl()->post(self::$HOST.self::$BOTKEY.'/'.$mtd, $par);
