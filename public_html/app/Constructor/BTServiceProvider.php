...
use App\Constructor\commands\CrudboosterVersionCommand;
use App\Constructor\commands\Mailqueues;
use Illuminate\Support\Facades\Artisan;
use Illuminate\Support\Facades\Validator;
use Illuminate\Support\ServiceProvider;
use App\Constructor\commands\CrudboosterInstallationCommand;
use App\Constructor\commands\CrudboosterUpdateCommand;
...
class BTServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $loader->alias('BTBooster', 'App\Constructor\helpers\BTBooster');
        $loader->alias('CB', 'App\Constructor\helpers\CB');
    }
