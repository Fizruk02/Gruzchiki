...
class CrudboosterUpdateCommand extends Command
{
     ...
     * @var string
     */
    protected $description = 'BTBooster Update Command';
    ...
    public function handle()
    {
        ...
        $this->info('Publishing BTBooster needs file...');
        ...
        $configLFMModified = str_replace("['web','auth']", "['web','\App\Constructor\middlewares\BTBackend']", $configLFM);
