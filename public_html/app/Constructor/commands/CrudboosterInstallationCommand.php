...
class CrudboosterInstallationCommand extends Command
{
     ...
     * @var string
     */
    protected $description = 'BTBooster Installation Command';
    ...
    public function handle()
    {
        ...
        if ($this->confirm('Do you have setting the database configuration at .env ?')) {
            ...
            $this->call('vendor:publish', ['--provider' => 'App\Constructor\BTBoosterServiceProvider']);
            ...
            $this->info('Installing BTBooster Is Completed ! Thank You :)');
        } else {
...
#
			");
        $this->info('--------- :===: Thanks for choosing BTBooster :==: ---------------');
        $this->info('====================================================================');
    }
