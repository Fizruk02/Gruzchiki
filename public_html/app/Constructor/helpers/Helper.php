...
/*
| ---------------------------------------------------------------------------------------------------------------
| Main Helper of BTBooster
| Do not edit or modify this helper unless your modification will be replace if any update from BTBooster.
|
...
if(!function_exists('get_setting')) {
    ...
    function get_setting($key, $default = null) {
        $setting = \App\Constructor\helpers\BT::getSetting($key);
