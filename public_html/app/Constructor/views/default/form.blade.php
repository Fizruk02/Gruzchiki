...
@section('content')
    ...
    <div>
        ...
        @if(BTBooster::getCurrentMethod() != 'getProfile' && $button_cancel)
            @if(g('return_url'))
                <p><a title='Return' href='{{g("return_url")}}'><i class='fa fa-chevron-circle-left '></i>
                        &nbsp; {{cbLang("form_back_to_list",['module'=>BTBooster::getCurrentModule()->name])}}</a></p>
            @else
                <p><a title='Main Module' href='{{BTBooster::mainpath()}}'><i class='fa fa-chevron-circle-left '></i>
                        &nbsp; {{cbLang("form_back_to_list",['module'=>BTBooster::getCurrentModule()->name])}}</a></p>
            @endif
        @endif
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <strong><i class='{{@BTBooster::getCurrentModule()->icon}}'></i> {!! $page_title !!}</strong>
            </div>
