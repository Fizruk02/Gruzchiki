...
$button_filter = $button_filter ?? null;
...
@section('content')
    ...
    <div class="box">
        <div class="box-header">
            @if($button_bulk_action && ( ($button_delete && BTBooster::isDelete()) || $button_selected) )
                <div class="pull-{{ cbLang('left') }}">
                    <div class="selected-action" style="display:inline-block;position:relative;">
                        ...
                        <ul class="dropdown-menu">
                            @if($button_delete && BTBooster::isDelete())
            ...
            <div class="box-tools pull-{{ cbLang('right') }}" style="position: relative;margin-top: -5px;margin-right: -10px">
                    ...
                    <div class="input-group">
                        ...
                        <div class="input-group-btn">
                            @if(Request::get('q'))
                                ...
                                ?>
                                <button type='button' onclick='location.href="{{ BTBooster::mainpath().$build_query}}"'
                ...
                <form method='get' id='form-limit-paging' style="display:inline-block" action='{{Request::url()}}'>
                    {!! BTBooster::getUrlParameters(['limit']) !!}
                    <div class="input-group">
