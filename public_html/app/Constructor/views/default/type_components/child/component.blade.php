                                                    ...
                                                    @push('bottom')
                                                        <script type="text/javascript">
                                                            ...
                                                            function uploadFiles{{$name_column}}(event) {
                                                                ...
                                                                $.ajax({
                                                                    url: '{{BTBooster::mainpath("upload-file")}}',
                                                                    type: 'POST',
                                                                    data: data,
                                                                    cache: false,
                                                    ...
                                                    >
                                                        ...
                                                        if ($col['datatable']) {
                                                            ...
                                                            if (! $col['datatable_where']) {
                                                                $data = BTBooster::get($tableJoin, NULL, "$titleField ASC");
                                                            } else {
                                                                $data = BTBooster::get($tableJoin, $col['datatable_where'], "$titleField ASC");
                                                            }
                                                            foreach ($data as $d) {
