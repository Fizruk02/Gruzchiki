    ...
    <section class="sidebar">
        ...
        <div class="user-panel">
            <div class="pull-{{ cbLang('left') }} image">
                <img src="{{ BTBooster::myPhoto() }}" class="img-circle" alt="{{ cbLang('user_image') }}"/>
            </div>
            <div class="pull-{{ cbLang('left') }} info">
                <p>{{ BTBooster::myName() }}</p>
                <!-- Status -->
        ...
        <div class='main-menu'>
            ...
            <ul class="sidebar-menu">
                ...
                <?php $dashboard = BTBooster::sidebarDashboard();?>
                @if($dashboard)
                    <li data-id='{{$dashboard->id}}' class="{{ (Request::is(config('crudbooster.ADMIN_PATH'))) ? 'active' : '' }}"><a
                                href='{{BTBooster::adminPath()}}' class='{{($dashboard->color)?"text-".$dashboard->color:""}}'><i class='fa fa-dashboard'></i>
                            <span>{{cbLang("text_dashboard")}}</span> </a></li>
                @endif

                @foreach(BTBooster::sidebarMenu() as $menu)
