...
@section('content')
    ...
    <div style="width:750px;margin:0 auto ">
        ...
        @if(BTBooster::getCurrentMethod() != 'getProfile')
            <p><a href='{{BTBooster::mainpath()}}'>{{cbLang("form_back_to_list",['module'=>BTBooster::getCurrentModule()->name])}}</a></p>
    @endif
        ...
        <div class="box box-primary">
            ...
            <form method='post' action='{{ (@$row->id)?route("PrivilegesControllerPostEditSave")."/$row->id":route("PrivilegesControllerPostAddSave") }}'>
                ...
                <div class="box-footer" align="right">
                    <button type='button' onclick="location.href='{{BTBooster::mainpath()}}'"
