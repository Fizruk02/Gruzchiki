...
?>
@if(file_exists(base_path('/app/Constructor/views/default/type_components/'.$type.'/asset.blade.php')))
...
<div class='table-responsive'>
    <table id='table-detail' class='table table-striped'>
        ...
        if ($join && @$row) {
            ...
            $join_table_pk = BT::pk($join_table);
            $join_fk = BT::getForeignKey($table, $join_table);
        ...
        $file_location = base_path('app/Constructor/views/default/type_components/'.$type.'/component_detail.blade.php');
