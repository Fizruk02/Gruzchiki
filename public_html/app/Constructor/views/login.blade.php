...
<head>
    ...
    <meta name='generator' content='BTBooster'/>
...
<!-- HTML5 Shim and Respond.js IE8 support of HTML5 elements and media queries -->
    ...
    <style type="text/css">
        .login-page, .register-page {
            background: {{ BTBooster::getSetting("login_background_color")?:'#dddddd'}} url('{{ BTBooster::getSetting("login_background_image")?asset(BTBooster::getSetting("login_background_image")):asset('vendor/crudbooster/assets/bg_blur3.jpg') }}');
            color: {{ BTBooster::getSetting("login_font_color")?:'#ffffff' }}  !important;
        ...
        .login-box-body {
            ...
            color: {{ BTBooster::getSetting("login_font_color")?:'#666666' }}  !important;
        }
...
<div class="login-box">
    <div class="login-logo">
        <a href="{{url('/')}}">
            <img title='{!!(Session::get('appname') == 'BTBooster')?"<b>CRUD</b>Booster":BTBooster::getSetting('appname')!!}'
                 src='{{ BTBooster::getSetting("logo")?asset(BTBooster::getSetting('logo')):asset('vendor/crudbooster/assets/logo_crudbooster.png') }}'
