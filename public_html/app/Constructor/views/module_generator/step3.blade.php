...
@section("content")
            ...
            $(function () {
                ...
                $(document).on('click', '.sub li', function () {
                    ...
                    if (input_name == 'type[]') {
                        ...
                        $.getJSON("{{BTBooster::mainpath('type-info')}}/" + v, function (data) {
    ...
    <div class="box box-default">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class='option_area' style="display: none">
                                    ...
                                    $type = @$form["type"] ?: "text";
                                    $types = base_path('app/Constructor/views/default/type_components/'.$type.'/info.json');
        ...
        <div class="box-footer">
            <div align="right">
                <button type="button" onclick="location.href='{{BTBooster::mainpath('step2').'/'.$id}}'" class="btn btn-default">&laquo; Back</button>
