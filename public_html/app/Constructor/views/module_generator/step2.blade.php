...
@section("content")
    ...
    @push('bottom')
        <script>
            ...
            function showTableFieldLike(t) {
                ...
                $.get("{{BTBooster::mainpath('table-columns')}}/" + table, function (response) {
                    t.next("ul").remove();
                    var list = '';
    ...
    <div class="box box-default">
        ...
        <div class="box-footer">
            <div align="right">
                <button type="button" onclick="location.href='{{BTBooster::mainpath('step1').'/'.$id}}'" class="btn btn-default">&laquo; Back</button>
