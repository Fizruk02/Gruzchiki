...
@section('content')
    ...
    <ul class="nav nav-tabs">
        <li class="active"><a href="{{ BTBooster::mainpath() }}"><i class='fa fa-file'></i> API Documentation</a></li>
        <li><a href="{{ BTBooster::mainpath('screet-key') }}"><i class='fa fa-key'></i> API Secret Key</a></li>
            ...
            <table class='table table-striped table-api table-bordered'>
                ...
                <tr class='info'>
                    ...
                    <th>API Name
                      ...
                      <a class='btn btn-xs btn-warning' target="_blank" href='{{BTBooster::mainpath("download-postman")}}'>Export For POSTMAN <sup>Beta</sup></a>
                    </span>
                    </th>
                </tr>
                </thead>
