<?php namespace App\Http\Controllers;
	...
	class AdminCabinetController extends \App\Constructor\controllers\BTController {
	    ...
	    public function cbInit() {
			...
			$this->form = [];
			$this->form[] = ['label'=>'User Id','name'=>'user_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Finish At','name'=>'finish_at','type'=>'datetime','validation'=>'required|date_format:Y-m-d H:i:s','width'=>'col-sm-10','datatable'=>'user,id'];
