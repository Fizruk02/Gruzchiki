<?php namespace App\Http\Controllers;
	...
	class RulesController extends \App\Constructor\controllers\BTController {
	    ...
	    public function cbInit() {
			...
			$this->form = [];
            $this->form[] = ['label'=>'Правила','name'=>'rules','type'=>'textarea','validation'=>'string|min:10|max:1000','width'=>'col-sm-10'];
