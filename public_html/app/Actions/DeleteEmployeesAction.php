...
class DeleteEmployeesAction extends Action
{
    use Confirmable;
    ...
    public function handle($selectedModels, View $view)
    {
        ...
        User::whereKey($selectedModels)->where('cabinet_id', $cabinet->id)->update(['is_deleted' => 1, 'role_id' => 0]);
        $this->success('Сотрудники удалены!');
    }
